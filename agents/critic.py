...
def critic_agent(state: AgentState) -> dict:
    ...
    prompt = ChatPromptTemplate.from_messages([
        ...
        1. Does it directly and completely answer the original question without going off topic?
        2. Is it concise — between 150 and 300 words, well structured and easy to read?
        3. Are the claims supported by the search results?
